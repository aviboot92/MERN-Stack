        ...
        <Fragment>
            ...
            <form className="form">
                ...
                {displaySocialInputs && (<Fragment>
                    ...
                    <input onChange={onChange} value={twitter} type="text" placeholder="Twitter URL" name="twitter"/>
                </div>

                <div className="form-group social-input">
                    <FontAwesomeIcon icon="fab fa-facebook fa-2x"/>
                    <input type="text" onChange={onChange} value={facebook} placeholder="Facebook URL" name="facebook"/>
                </div>

                <div className="form-group social-input">
                    <FontAwesomeIcon icon="fab fa-youtube fa-2x"/>
                    <input type="text" onChange={onChange} value={youtube} placeholder="YouTube URL" name="youtube"/>
                </div>

                <div className="form-group social-input">
                    <FontAwesomeIcon icon="fab fa-linkedin fa-2x"/>
                    <input type="text" onChange ={onChange} value={linkedin}placeholder="Linkedin URL" name="linkedin"/>
                </div>

                <div className="form-group social-input">
                    <FontAwesomeIcon icon="fab fa-instagram fa-2x"/>
                    <input type="text" onChange={onChange} value={instagram}placeholder="Instagram URL" name="instagram"/>
                </div>
                </Fragment>)}
